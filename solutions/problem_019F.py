...
# (1*)
# If Sunday = 0, Monday = 1, Tuesday = 2... and we know that the first day of
# the year 1901 is Monday, we can initialize the current day value to 1. After
# the next month passes, the first day of February would be (1 + 31) mod 7,
# which is 4, so Thursday. This way, if for the first day of any month the
# value that keeps track of the days is 0, we know it fell on a Sunday.
