...
# notation sqrt(24) = [4; (1, 3, 1, 8)], to indicate that the block
...
# We can now set base1 = 7, and notice that we obtained it by doing the
# operation:
...
# We can set c1 = a1*base1 - c0, and we will have that the remaining fraction:
#         (sqrt(23) + c1)/base1
