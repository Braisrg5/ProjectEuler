...
def possible_combinations():
    ...
    for p in primes:
        # Sorted string of its digits (to have uniqueness)
...
def find_sequence():
    ...
    for primes in possible.values():
        ...
        diff_dict = {}
        # Number of primes in the family.
        num_values = len(primes)

        # We take every possible pair (i, j) where i < j, so pi < pj
        for i in range(num_values-1):
            for j in range(i+1, num_values):
                ...
                # If the difference is already in the dictionary
                    ...
                    # and either pi or pj is in the existing pair for this
