...
# 28 would be 1 + 2 + 4 + 7 = 28, which means that 28 is a perfect number.
...
# For each abundant number num, we check if the difference n - num is also in
# the set of abundant numbers. If both num and (n - num) are abundant numbers,
# then n can be expressed as the sum of two abundant numbers,
# num + (n - num) = n.
