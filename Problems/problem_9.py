...
'''The crux of the problem resides in finding the numbers a, b and c. With a 
bit of mathematical reasoning, we can simplify the problem:
...
def checkOp(a,b):
    '''Check the aforementioned operation.
    '''
